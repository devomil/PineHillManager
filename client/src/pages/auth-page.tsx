    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Pine Hill Farm
          </h1>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder="john@pinehillfarm.co"
        ...
        <div className="text-center mt-6 text-sm text-gray-600 dark:text-gray-400">
          <p>Pine Hill Farm Employee Portal</p>
          <p>Lake Geneva • Watertown Retail • Watertown Spa</p>
        </div>
      </div>
    </div>
  );
