...
function PurchaseOrdersTab() {
  ...
  const createPOMutation = useMutation({
    mutationFn: async (data: z.infer<typeof purchaseOrderFormSchema>) => {
      ...
      return apiRequest('POST', '/api/purchasing/purchase-orders', {
        ...
        expectedChargeDate: data.expectedChargeDate || null,
  ...
  const handleEditPO = (po: PurchaseOrder) => {
    ...
    poForm.reset({
      ...
      expectedChargeDate: (po as any).expectedChargeDate || '',
      locationId: po.locationId ? po.locationId.toString() : undefined,
