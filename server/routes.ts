...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Static routes removed - React app handles all UI

  // All static HTML routes removed - React app handles UI

  // Remove server-side dashboard route - React app handles all UI routing

  // Remove announcements-view route - React app handles all UI routing

  // Remove /schedule route - React app handles all UI routing
