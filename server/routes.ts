  ...
  app.get('/static', (req, res) => {
    res.send(`
      ...
      <head>
        ...
        <style>
          @import url('https://fonts.googleapis.com/css2?family=Birthstone+Bounce:wght@400:wght@400;500;600;700&display=swap');
          * { margin: 0; padding: 0; box-sizing: border-box; }
          body { 
          .pine-hill-title { font-family: "Birthstone", cursive; font-weight: 600; }
          @import url("https://fonts.googleapis.com/css2?family=Birthstone+Bounce:wght@400:wght@400;500;600;700&display=swap");
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
            background: linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 100%);
            min-height: 100vh; color: #1e293b; padding: 2rem;
          }
          .pine-hill-title { font-family: 'Birthstone', cursive; }
